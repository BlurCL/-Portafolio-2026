...
public class CalculoService {
    ...
    public Map<String, Object> obtenerObraDesdeServicio(Integer id) {
        ...
        try {
            Map<String, Object> obra = (Map<String, Object>) restTemplate.getForObject(url, Map.class);

            System.out.println("🔥 Obra recibida desde obras-service: " + obra);

            return obra;
        } catch (Exception e) {
            System.err.println("❌ Error al obtener obra desde obras-service: " + e.getMessage());
            return new HashMap<>();
        }
    }
    ...
    public CalculoObraResponse calcularObra(Integer idObra) {
        ...
        // Por ahora usamos obras-service solo para confirmar comunicación.
        // Las reglas y medidas siguen saliendo desde la BD como ya funcionaba.
